         ...
         <div class="container-fluid">
            ...
            <div class="bs-docs-example"> 
                 <ul class="nav nav-pills">
                    <li class="active"><a href="admin_about_us.php">History</a></li>
					<li class="dropdown ">
								...
								if($tCount!=0){
									while($rowTerm = mysql_fetch_array($term)){
										...
										echo"<li role='presentation'>
												<a href='admin_about_us_off.php?term=$start' role='menuitem'>$start - $end</a>
											 </li>";
									}
								}else{
					...
					<li ><a href="admin_about_us_sys.php">System</a></li>
                </ul>
            </div>   
            <!--END PILLS NAV-->
			...
			<div class="row-fluid">	
				...
				<div class="span12">
					...
					<div class="span8">
						<img src="images/logo/description.png" alt="">
					</div>
				</div>
			</div>
