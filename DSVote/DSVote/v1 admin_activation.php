      ...
      <div id="main-content">
        ...
        <div class="container-fluid">
			...
			<?php 
				...
				$application = mysql_query("SELECT act_status FROM activation WHERE act_type = 'Application' ORDER BY act_date AND act_time LIMIT 1");
				...
				$votation = mysql_query("SELECT act_status FROM activation WHERE act_type = 'Votation' ORDER BY act_date AND act_time LIMIT 1");
				...
				$results = mysql_query("SELECT act_status FROM activation WHERE act_type = 'Results' ORDER BY act_date AND act_time LIMIT 1");
