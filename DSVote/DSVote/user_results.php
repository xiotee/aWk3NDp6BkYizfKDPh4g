         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
					...
					<?php
						$resSql=mysql_query("SELECT act_status FROM activation WHERE act_type = 'Results' ORDER BY activate_id DESC LIMIT 1");
						$result = mysql_fetch_assoc($resSql);
						$res_status= $result['act_status'];
						
						if(mysql_num_rows($resSql) !=0 ){
							
							if(strcasecmp($res_status, "Deactivated") == 0){
					
								echo "<br><h4><b><font color='green'> Information</font> </b></h4>";
								echo "<label> Results are not yet available. </label>";
					
							}else{
								include("includes/user/user_display_results.php");
							}
						}else{
							echo "<br><h4><b><font color='green'> Information</font> </b></h4>";
							echo "<label> Results are not yet available. </label>";
