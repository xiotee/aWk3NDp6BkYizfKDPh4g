<?php
	...
	$retActivation = mysql_query("SELECT * FROM activation WHERE act_type = 'Application' ");
	
		$ret_stat = mysql_fetch_assoc($retActivation);
		$app_stat = $ret_stat['act_status'];
?>
         ...
         <div class="container-fluid" >
            ...
            <div class="bs-docs-example"> 
                 <ul class="nav nav-pills">
					<li class="active"><a href="#appForm" id="formApp" data-toggle="tab">Application Form</a>
					</li>
					<li><a href="#posDesc" id="descPos" data-toggle="tab">Position Description</a>
					</li> 
                </ul>
            </div>   
            <!--END PILLS NAV-->
            ...
            <!-- BEGIN PAGE CONTENT-->
			<div class="row-fluid tab-pane active in" id="appForm">
                <div class="span12">
                    ...
                    <div class="widget black">	
                        ...
                        <div class="widget-body">
									...
									<?php
										...
										/*display alert*/
										include("includes/user/apply/apply_alerts.php");
										
									
										/*display apply_form or information if admin activate/deactivate application*/
										$applySql=mysql_query("SELECT act_status FROM activation WHERE act_type = 'Application' ORDER BY activate_id DESC LIMIT 1");
										$apply = mysql_fetch_assoc($applySql);
										$apply_status= $apply['act_status'];
										
										if(mysql_num_rows($applySql) !=0 ){
											
											if(strcasecmp($apply_status, "Activated") == 0){
									
												include("includes/user/apply/user_apply_form.php");
									
											}else{
												echo "<br><h4><b><font color='green'> Information</font> </b></h4>";
												echo "<label> Application for DS Officer(s) is not yet available. </label>";
...
<div class="container-fluid">		 
<div class="tab-pane" id="posDesc" style="display: none;">		 
		 	<!-- CONTENT -->
   ...
   <script>
		function confirmation(){
		  var con = confirm("Are you sure you want to send this application?");
		  if(con == true){
			alert("Application done!");
			return true;
		  }else{
			alert("Applicaton was not sent!");
			return false;
		  }
	...
	<script>
			$('#descPos').click(function(){
				$('#appForm').hide();
				$('#posDesc').show();
			});
			$('#formApp').click(function(){
				$('#appForm').show();
				$('#posDesc').hide();
			});			
	</script>
